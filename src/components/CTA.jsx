...
const CTA = () => {
  return (
    <div className="mx-[1rem] border border-[#ff5227] rounded-[1rem] lg:p-[4rem] p-[1rem] lg:text-center text-start flex lg:items-center lg:justify-center my-[3rem] lg:mx-[2rem]">
      ...
      <div className="!block lg:w-[800px] w-full lg:text-center text-start">
        <BlurText
          ...
          animateBy="words"
          direction="top"
          className="!block lg:text-[3rem] text-[2rem] text-center"
        />
      </div>
    </div>
  );
